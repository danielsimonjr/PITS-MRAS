...
This is a **research and engineering exploration** combining control theory with modern AI/ML (see [CHANGELOG.md](./CHANGELOG.md) for release history):
...
- **[CHANGELOG.md](./CHANGELOG.md)** - released versions and what landed in each
...
The package ships the full build (config/math → models → losses → controllers →
training → inference → examples → tests → CI) plus:
