...
This is a **research and engineering exploration** combining control theory with modern AI/ML. **Released through v0.4.2** (see [CHANGELOG.md](./CHANGELOG.md)):
...
- 🔄 **Experimental validation** - the bundled examples run on **toy linear reference-model surrogates** (not high-fidelity plants); higher-fidelity plants and real-world testing are queued for the v0.4.x line
...
> experimentally validated.** The current example plants are toy linear
> surrogates; the numbers below describe what the framework aims for, and become
> measurable once the higher-fidelity plants (queued for v0.4.x) land.
